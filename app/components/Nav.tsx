      ...
      <nav className="fixed mx-5 mt-4 top-0 left-0 right-0 z-50 bg-[#1D1E40] text-white">
        <div className="mx-4 h-20 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            <a href="#home" className="text-white hover:bg-[#8b7dff] transition-colors p-2">
              Home
            </a>
            <a href="#why-it-works" className="text-white hover:bg-[#8b7dff] transition-colors p-2">
              Why It Works
            </a>
            <a href="#services" className="text-white hover:bg-[#8b7dff] transition-colors p-2">
              Services
            </a>
            <a href="#faqs" className="text-white hover:bg-[#8b7dff] transition-colors p-2">
              FAQs
            </a>
          </div>

          {/* Desktop CTA Button */}
          <button onClick={() => setOpenEstimate(true)}  className="hidden md:block bg-[#675CE7] hover:bg-[#7a6bef] text-white font-semibold px-6 py-3 rounded transition-colors">
            BOOK FREE ESTIMATE
          </button>
