        ...
        <div className="border-t border-gray-200 pt-8">
          <div className="text-center space-y-4">
            ...
            <div className="flex items-center justify-center gap-6 pt-4">
              <a href="https://web.facebook.com/people/Jolawt-International/61584082553649/" className="text-gray-600 hover:text-[#8b7dff] transition-colors" aria-label="Facebook">
                <Facebook size={20} />
              </a>
              <a href="https://www.instagram.com/jolawt_international/" className="text-gray-600 hover:text-[#8b7dff] transition-colors" aria-label="Instagram">
                <Instagram size={20} />
              </a>
              <a href="https://www.linkedin.com/in/jolawt-international-439911399/" className="text-gray-600 hover:text-[#8b7dff] transition-colors" aria-label="LinkedIn">
                <Linkedin size={20} />
              </a>
              ...
              <a href="https://www.tiktok.com/@jolawt_international" className="text-gray-600 hover:text-[#8b7dff] transition-colors" aria-label="TikTok">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.86-4.43v-7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1-.1z"/>
                </svg>
              </a>
              <a href="https://x.com/jolawt_inter" className="text-gray-600 hover:text-[#8b7dff] transition-colors" aria-label="Twitter/X">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
